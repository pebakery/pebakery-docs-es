...
| :---: | --- | --- |
| 0 | [Text Box](./TextBox.md) | Un cuadro de entrada que acepta una sola línea de texto. |
| 1 | [Text Label](./TextLabel.md) | Muestra una línea de texto. |
| 2 | [Number Box](./NumberBox.md) | Un cuadro de entrada que acepta un número entre un rango mínimo y máximo determinado. |
| 3 | [Check Box](./CheckBox.md) | Una caja que se puede "marcar" o "desmarcar". |
| 4 | [Combo Box](./ComboBox.md) | Una lista desplegable que le permite seleccionar un solo valor. |
| 5 | [Image](./Image.md) | Muestra una imagen incrustada en el script. |
| 6 | [Text File](./TextFile.md) | Muestra un archivo de texto incrustado en el script. |
| 7 | Text Edit | **No se ha implementado** - Las alternativas, como abrir el archivo con *notepad.exe* son más flexibles. |
| 8 | [Button](./Button.md) | Un botón simple que se puede usar para ejecutar una sección de código dentro del script. |
| 9 | Check List | **No se ha implementado** - No hay suficiente interés. Casos de uso limitado. |
| 10 | [Web Label](./WebLabel.md) | Un hipervínculo que abrirá una página web en el navegador predeterminado. |
| 11 | [Radio Button](./RadioButton.md) | Un botón circular que puede tener solo un botón de radio seleccionado en la interfaz a la vez. |
| 12 | [Bevel](./Bevel.md) | Un marco rectangular utilizado para organizar controles. |
| 13 | [File Box](./FileBox.md) | Un cuadro de entrada con un botón de navegación que le permite seleccionar un archivo o directorio. |
| 14 | [Radio Group](./RadioGroup.md) | Un grupo de botones de radio Solo se puede seleccionar un botón de opción por grupo a la vez. |
